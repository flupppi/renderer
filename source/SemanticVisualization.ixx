...
//************************************
	...
	void SemanticVisualization::GenerateRayTraceImage()
	{
	...
	void SemanticVisualization::Update(double deltaTime)
	{
		...
		else if (m_input.IsKeyDown(GLFW_KEY_B)) {
			filterClass = "box";
			std::cout << "Filtering for boxes\n";

		}
		else if (m_input.IsKeyDown(GLFW_KEY_C)) {
			filterClass = "cone";
			std::cout << "Filtering for cones\n";
		}
		else if (m_input.IsKeyDown(GLFW_KEY_A)) {
			filterClass = "";
		...
		if (m_input.IsKeyDown(GLFW_KEY_I)) {
			drawInstanceBoundary = !drawInstanceBoundary;
		}
		if (m_input.IsKeyDown(GLFW_KEY_M)) {
		...
		if (m_input.IsKeyDown(GLFW_KEY_V)) {
